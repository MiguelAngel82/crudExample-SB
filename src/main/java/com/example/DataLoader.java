...
public class DataLoader {
	...
	private void loadData(){
		...
		// create an author
		Author dv = new Author("Dan","Vega","danvega@example.com");
	...
	private void createAuthors() {
		Author jv = new Author("Joe","Vega","jvega@example.com");
		authorRepository.save(jv);
		Author av = new Author("Andy","Vega","avega@example.com");
		authorRepository.save(av);
		Author kv = new Author("Katie","Vega","kvega@example.com");
